...
namespace CASimulator
{
    ...
    /// <summary>
    /// A disposable cross-platform wrapper around a WriteableBitmap, allowing
    /// a common API for WPF with locking + unlocking if necessary
    /// </summary>
    /// <remarks>Attempting to put as many preprocessor hacks in this file, to
    /// keep the rest of the codebase relatively clean</remarks>
    public unsafe struct BitmapContext : IDisposable
    {
        ...
        private readonly static IDictionary<WriteableBitmap, int>UpdateCountByBmp =
            new System.Collections.Concurrent.ConcurrentDictionary<WriteableBitmap, int>();
        ...
        public BitmapContext(WriteableBitmap writeableBitmap, ReadWriteMode mode)
        {
            ...
            double width = _writeableBitmap.BackBufferStride / WriteableBitmapEx.SizeOfArgb;
        ...
        /// </summary>
        /// <remarks>Equivalent to calling native memcpy in WPF</remarks>
        [System.Runtime.TargetedPatchingOptOut("Candidate for inlining across NGen boundaries for performance reasons")]
        ...
        public void Clear()
        {
            NativeMethods.SetUnmanagedMemory(_writeableBitmap.BackBuffer, 0,
                _writeableBitmap.BackBufferStride * _writeableBitmap.PixelHeight);
        }

        /// <summary>
        /// Disposes the BitmapContext, unlocking it and invalidating for WPF
        /// </summary>
        public void Dispose()
        {
